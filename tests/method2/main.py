...
from test_png import compare_images_pixel_perfect
from test_cam_pose_reg_result import calculate_target_robot_pose
from compute_registration_error import compute_registration_error
...
async def run_fuel(arm_id: int, stereo_matcher: StereoMatcherService,
    ...
    if strategy == 'method2':
        ...
        template_img = cv2.imread('/home/vision/projects/fueling/fueling/initialization/orbbec_output/Flood_light/arm2/captured_left_ir.png')
...
async def main():
    ...
    config_files = [f for f in config_files if os.path.isfile(f)]  # 暂时2台
